...
describe('학교 정보 API e2e', () => {
	...
	describe('학식 API 동작 테스트', () => {
		...
		const lastSunday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() - 1
		);
		const thisTuesday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() + 1
		);
		const thisWednesday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() + 2
		);
		const thisThursday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() + 3
		);
		const thisFriday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() + 4
		);
		const thisSaturday = new Date(
			date.getFullYear(), date.getMonth() - 1, thisMonday.getDate() + 5
		);
